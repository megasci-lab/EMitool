...
setwd("D:/huadong/project/mutil_omics/R_packages/EMitool")
load("D:/huadong/project/mutil_omics/R_packages/EMitool/data/GeneExp.rda")
load("D:/huadong/project/mutil_omics/R_packages/EMitool/data/MethyExp.rda")
load("D:/huadong/project/mutil_omics/R_packages/EMitool/data/miRNAExp.rda")
...
#write.xlsx(W,file="./tests/testthat/W.xlsx",row.names=TRUE)
